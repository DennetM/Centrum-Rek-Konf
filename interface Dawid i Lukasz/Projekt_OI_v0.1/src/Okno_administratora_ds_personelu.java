...
*/
public class Okno_administratora_ds_personelu extends javax.swing.JDialog {
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				...
				Okno_administratora_ds_personelu inst = new Okno_administratora_ds_personelu(frame);
	...
	public Okno_administratora_ds_personelu(JFrame frame) {
		super(frame);
		initGUI();
	}
